                ...
                <div class="row">
                    <div class="c-12">
                        <div class="story-nation__wrap">
                            <?php                       
                                $sql_tongtruyen = "SELECT *,stories.updated as ngay, COUNT(story_id) as tong FROM `chapters`,`stories` where category_id=$categoris_id and chapters.story_id = stories.id GROUP BY chapters.story_id";
