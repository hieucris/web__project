              ...
              <div class="row">
                <div class="c-12">
                  <ul class="breadcrumb-list">
                    ...
                    <li class="breadcrumb-item active"><a href="">Truyện Trung Quốc</a></li>
                  </ul>
                </div>
              </div>
            </div>
                ...
                <div class="row">
                    <div class="c-12">
                        <div class="story-nation__wrap">
                            <?php                       
                                $sql_tongtruyen = "SELECT *,stories.updated as ngay, COUNT(story_id) as tong FROM `chapters`,`stories` where country='Trung Quốc' and chapters.story_id = stories.id GROUP BY chapters.story_id";
