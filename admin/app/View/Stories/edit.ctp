                                ...
                                <div class="col-lg-6">
                                    <?php echo $this->Form->create('Story',array('id'=>'appForm', 'inputDefaults'=>array('label'=>false, 'div'=>false),'enctype' => 'multipart/form-data')); ?>
                                        ...
                                        <div class="form-group">
                                            <label>Tác giả</label>
                                            <?php
                                                echo $this->Form->input('author', array('class'=>'form-control','id'=>'inputAuthor', 'maxlength'=>'100','value'=>$detail['Story']['author']));
                                            ?>
                                            <?php if(!empty($error['name'])):?>
                                            <span style="color:red;"><?php echo $error['name'];?></span>
                                            <?php endif;?>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <?php
                                                echo $this->Form->input('country', array('class'=>'form-control','id'=>'inputCountry', 'maxlength'=>'100','value'=>$detail['Story']['country']));
                                            ?>
                                            <?php if(!empty($error['name'])):?>
                                            <span style="color:red;"><?php echo $error['name'];?></span>
                                            <?php endif;?>
