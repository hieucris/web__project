    ...
    <ul class="nav navbar-top-links navbar-right">
        ...
        <li class="dropdown">
            ...
            <ul class="dropdown-menu dropdown-user">
                ...
                <li class="divider"></li>
                <li>
                    <a href="/w/admin/"><i class="fa fa-sign-out fa-fw"></i> Logout</a>
                </li>
            </ul>
            <!-- /.dropdown-user -->
        </li>
        ...
        <div class="sidebar-nav navbar-collapse">
            <ul class="nav" id="side-menu">
                ...
                <li>
                    ...
                    <ul class="nav nav-second-level">
                    <li>
                        <?php echo $this->Html->link('List',array('controller'=>'categories','action'=>'list'),array('escape'=>false))?>
                    </li>
                    <li>
                 ...
                 <li>
                    ...
                    <ul class="nav nav-second-level">
                        <li>
                            <?php echo $this->Html->link('List',array('controller'=>'stories','action'=>'list'),array('escape'=>false))?>
                        </li>
                        <li>
                ...
                <li>
                    ...
                    <ul class="nav nav-second-level">
                        <li>
                             <?php echo $this->Html->link('List',array('controller'=>'chapters','action'=>'list'),array('escape'=>false))?>
                        </li>
                        <li>
