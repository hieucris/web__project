...
{
    var $layout = 'admin';
    var $uses = array('Category','Story','Country');
    ...
    public function edit($id = null){
        ...
        $detail = $this->Story->find('first', array(
            'fields' => array('id', 'name','description', 'category_id', 'author','country'),
            'conditions'=>array('id = '.$id),
            'recursive'   =>-1
        ));
        ...
        if($this->request->is('post')){
            ...
            if($arrParams['author']==null){
                $error['author'] = 'Tên tác giả không thể rỗng';
            }if($arrParams['country']==null){
                $error['country'] = 'Tên quốc gia không thể rỗng';
            }
            ...
            if(empty($error)){
                ...
                $arrParams['img'] = 'admin/app/webroot/img/stories/' . $file_name;
